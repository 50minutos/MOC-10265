...
namespace _021_LinqToDataSet
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var produto in produtos) //foreach (var linha in dt.Rows)
            {
                foreach (var campo in produto.ItemArray) //foreach (var coluna in dt.Columns)
                {
                    Console.Write("{0} ", campo); //linha[coluna]
                }
